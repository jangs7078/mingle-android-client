...
public class MainActivity extends ActionBarActivity {
    ...
    private LatLng getCurrentLocation() {
        ...
        double longitude= 0;
        if ( location != null) {
        	System.out.println("Successful in retrieving location!!");
        	latitude = location.getLatitude();
        	longitude = location.getLongitude();
        } 
        
        System.out.println("The user is at Lat: " + String.valueOf(latitude) + " long: " + String.valueOf(longitude) );
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LatLng curLoc = getCurrentLocation();
        ((MingleApplication) this.getApplication()).currUser.setLat((float)curLoc.latitude);
        ((MingleApplication) this.getApplication()).currUser.setLat((float)curLoc.longitude);
